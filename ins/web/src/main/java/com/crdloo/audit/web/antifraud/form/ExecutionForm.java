package com.crdloo.audit.web.antifraud.form;
...
public class ExecutionForm implements Serializable{
	private static final long serialVersionUID = 1552050206371745758L;
	private Long id;
	private String swift_number = "";//流水号
	private Integer flag_execution;// 计费标识:1计费，0不计费
	/**
	 * 
		1、bad1表示的是用户失信被执行第一个案件 
		李阳:
		2、execut1表示的是用户被执行第一个案件 
	 */
