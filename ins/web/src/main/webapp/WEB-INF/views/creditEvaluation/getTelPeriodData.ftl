			...
			<div class="page-head">
				...
				<div class="clearfix">
					<div class="bread-crumb pull-right">
						<form class="bs-example bs-example-form" role="form"  action="${root}/service/creditEvaluation/exportTelPeriodPdf" onsubmit="return toVaild()" method="post" >
						...
						<div class="col-md-12">
							<div class="widget">
								...
								<div class="widget-head clearfix">
									<div class="pull-left mtop5">手机在网时长结果</div>
									...
									<table class="table table-striped table-bordered table-hover results">
										<thead>
											<tr>
												...
												<td class="col-md-3">${telPeriodForm.result}</td>
												<th class="col-md-3">运营商类别</th>
												<td class="col-md-3">${telPeriodForm.operation}</td>
											</tr>
											<tr>
												<th class="col-md-3">手机在网时长区间</th>
												<td class="col-md-3">${telPeriodForm.value}</td>
