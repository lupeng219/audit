package com.crdloo.audit.platform.example.service.vo;

import org.apache.commons.lang.builder.ReflectionToStringBuilder;

public class RuleRsVo {

	private String code;
	private String swift_number;
	private String rule_final_weight;
	private String rule_final_decision;
	private String rule_weight_QJ100;
	private String rule_name_QJ100;
	private String rule_weight_QJF010;
	private String rule_name_QJF010;
	private String rule_weight_QJF020;
	private String rule_name_QJF020;
	...
	public String getRule_weight_QJ100() {
		return rule_weight_QJ100;
	}

	public void setRule_weight_QJ100(String rule_weight_QJ100) {
		this.rule_weight_QJ100 = rule_weight_QJ100;
	}

	public String getRule_name_QJ100() {
		return rule_name_QJ100;
	}

	public void setRule_name_QJ100(String rule_name_QJ100) {
		this.rule_name_QJ100 = rule_name_QJ100;
	}

	public String getRule_weight_QJF010() {
		return rule_weight_QJF010;
	}

	public void setRule_weight_QJF010(String rule_weight_QJF010) {
		this.rule_weight_QJF010 = rule_weight_QJF010;
	}

	public String getRule_name_QJF010() {
		return rule_name_QJF010;
	}

	public void setRule_name_QJF010(String rule_name_QJF010) {
		this.rule_name_QJF010 = rule_name_QJF010;
	}

	public String getRule_weight_QJF020() {
		return rule_weight_QJF020;
	}

	public void setRule_weight_QJF020(String rule_weight_QJF020) {
		this.rule_weight_QJF020 = rule_weight_QJF020;
	}

	public String getRule_name_QJF020() {
		return rule_name_QJF020;
	}

	public void setRule_name_QJF020(String rule_name_QJF020) {
		this.rule_name_QJF020 = rule_name_QJF020;
	}
